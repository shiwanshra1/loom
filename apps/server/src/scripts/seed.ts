...
const SEED_ACCOUNTS: SeedAccount[] = [
  ...
  // The top-level Forge Admin is branded "Super Winnovation Admin" — there's
  // no display-name field for ForgeAdmin anywhere in the schema (no profile
  // table, see profileFactory.ts's no-op case), so the identity lives in the
  // email address and in the client's hardcoded dashboard heading instead.
  {
    email: 'superadmin@winnovation.org',
    displayName: 'Super Winnovation Admin',
